        ...
        certificados: [
            {
                ...
                status: "issued",
                declaration: "Certificamos que o participante concluiu o curso Node.js para Iniciantes.",
            },
        ],
    },
    {
        ...
        certificados: [
            {
                ...
                status: "issued",
                declaration: "Certificamos que o participante concluiu o curso JavaScript Moderno e Avançado.",
            },
        ],
    },
    {
        ...
        certificados: [
            {
                ...
                status: "issued",
                declaration: "Certificamos que o participante concluiu o curso Desenvolvimento de APIs RESTful com Express.",
            },
        ],
    },
    {
        ...
        certificados: [
            {
                ...
                status: "issued",
                declaration: "Certificamos que o participante concluiu o curso Fundamentos de Estatística para Iniciantes.",
            },
        ],
    },
    {
        ...
        certificados: [
            {
                ...
                status: "issued",
                declaration: "Certificamos que o participante concluiu o curso Matemática Financeira Aplicada.",
            },
        ],
    },
    {
        ...
        certificados: [
            {
                ...
                status: "issued",
                declaration: "Certificamos que o participante concluiu o curso Python Prático para Data Science.",
            },
        ],
    },
    {
        ...
        certificados: [
            {
                ...
                status: "issued",
                declaration: "Certificamos que o participante concluiu o curso Laboratório de Física Experimental.",
            },
        ],
    },
    {
        ...
        certificados: [
            {
                ...
                status: "issued",
                declaration: "Certificamos que o participante concluiu o curso Cálculo Diferencial e Integral I.",
            },
        ],
    },
    {
        ...
        certificados: [
            {
                ...
                status: "issued",
                declaration: "Certificamos que o participante concluiu o curso Mecânica dos Materiais para Engenharia.",
            },
        ],
    },
    {
        ...
        certificados: [
            {
                ...
                status: "issued",
                declaration: "Certificamos que o participante concluiu o curso Química Orgânica Estrutural.",
            },
        ],
    },
    {
        ...
        certificados: [
            {
                ...
                status: "issued",
                declaration: "Certificamos que o participante concluiu o curso Biologia Celular e Molecular.",
            },
        ],
    },
    {
        ...
        certificados: [
            {
                ...
                status: "issued",
                declaration: "Certificamos que o participante concluiu o curso Ecologia Aplicada.",
            },
        ],
    },
    {
        ...
        certificados: [
            {
                ...
                status: "issued",
                declaration: "Certificamos que o participante concluiu o curso História do Brasil: Da Colônia à República.",
            },
        ],
    },
    {
        ...
        certificados: [
            {
                ...
                status: "issued",
                declaration: "Certificamos que o participante concluiu o curso Sociologia Contemporânea e Problemas Sociais.",
            },
        ],
    },
    {
        ...
        certificados: [
            {
                ...
                status: "issued",
                declaration: "Certificamos que o participante concluiu o curso Introdução à Filosofia: Pensamento Ocidental.",
            },
        ],
    },
];
async function atribuirCertificadosAosCursos() {
    await mongo_1.default.connection.dropCollection("certificates").catch(() => { });
    await mongo_1.default.connection;
    for (const grupo of certificadosPorCurso) {
        // Busca o curso pelo título
        const curso = await Course_1.default.findOne({ title: grupo.curso });
        if (curso) {
            ...
            for (const cert of grupo.certificados) {
                ...
                await Certificate_1.default.create(cert);
            }
            // Extrai os IDs dos certificados
            const certificadosIds = grupo.certificados.map((cert) => cert.certificateId);
            // Atualiza o campo certificates do curso
            await Course_1.default.updateOne({ _id: curso._id }, { $set: { certificates: certificadosIds } });
        }
    }
    console.log("\x1b[32m✔ Certificados inseridos e atribuídos aos cursos!\x1b[0m");
